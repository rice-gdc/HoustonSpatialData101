# The Rice Urban Sustainability Hackathon - Houston Spatial Data 101
...
## ArcGIS Living Atlas
[ArcGIS Living Atlas of the World](https://livingatlas.arcgis.com/en/home/) is trusted, authortative collection of spatial data managed by the developers of ArcGIS, Esri. Living Atlas datasets tend to be national or global in nature, but since Houston is a part of the United States and the world, there's a lot of useful data here. Datasets can be browsed by type or theme and searched by keyword. **Click** the *waffle* in the upper right of the [ArcGIS Online home page](https://ricegis.maps.arcgis.com/) and select [Living Atlas](https://livingatlas.arcgis.com/en/home/) to begin browsing or searching. 

## ArcGIS Online 
In addition to the Living Atlas, many other spatial datasets from government agencies, universities, and researchers to casual users are uploaded and stored in the ArcGIS Online system. Since any user can upload data, there's no guarentee that this data is up-to-date, accurate or high-quality. Search by Rice University or the entire world using the large search bar at the top of the ArcGIS Online homepage. 

# Rice University
## GIS/Data Center
The [GIS/Data Center](https://library.rice.edu/places/gisdata-center-gdc) hosts large datasets for researchers in the Rice community, including regional high-resolution aerial photography, LiDAR point clouds and DEMs, and spatial databases of addresses, customers, and businesses. This data can be accessed from our GIS Lab in B40 in the basement of Fondren Library. 

## Kinder Urban Data Platform
[The Kinder Institute for Urban Research, Urban Data Platfrom](https://www.kinderudp.org/) is a secure data repository of research-ready geocoded data for the greater Houston area and includes high-quality datasets on education, housing, the environment, health, and transportation. 
...
- [Capitol Data Portal](https://data.capitol.texas.gov/): This data portal includes data on districts and redistricting, precincts and **voting tabulation districts (VTDs)** and election results.
...
- [The US Census](https://www.census.gov/geographies/mapping-files.html): The official collection of US Census data shapefiles for census tracts and other boundaries. [Demographic data can be downloaded here](https://data.census.gov/) and must be joined to these shapefiles. Alternatively, recent data can be collected from [ArcGIS Online](https://livingatlas.arcgis.com/en/browse/?q=census#q=census&d=2) or [Social Explorer](https://www.socialexplorer.com/my-home)
...
*Contact the [Rice GIS/Data Center](https://library.rice.edu/places/gisdata-center-gdc) or the [GIS Specialist at Fondren Library](gisdata@rice.edu) if you need help or guidance, or have any questions. Many other data soures for spatial data, check out the University of Houston at Clear Lake guide for other datasets: [UHCL LibGuide for GIS Data](https://uhcl.libguides.com/c.php?g=1052809&p=7662083)* 
